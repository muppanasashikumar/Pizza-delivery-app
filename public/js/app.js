...
function deductCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/deduct-cart', pizza).then(function (res) {
    //console.log(res)
    cartCounter.innerText = res.data.totalQty;
  });
}
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); //console.log(e.currentTarget.className)
